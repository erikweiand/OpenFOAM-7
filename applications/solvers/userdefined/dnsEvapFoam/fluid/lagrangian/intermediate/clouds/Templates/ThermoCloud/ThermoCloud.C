...
:
    ...
    hsTrans_(nullptr),
    hsCoeff_(nullptr), 
    hTrans_(nullptr) // M.P.Sitte, 23/11/2016
{}
...
void Foam::ThermoCloud<CloudType>::resetSourceTerms()
{
    ...
    hsTrans_->field() = 0.0;
    hsCoeff_->field() = 0.0;
    hTrans_->field() = 0.0; // M.P.Sitte, 23/11/2016
...
)
{
    ...
    this->relax(hTrans_(), cloudOldTime.hTrans(), "h");  // M.P.Sitte,23/11/2016
...
void Foam::ThermoCloud<CloudType>::scaleSources()
{
    ...
    this->scale(hTrans_(), "h"); // M.P.Sitte,23/11/2016
