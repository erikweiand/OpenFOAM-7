...
// M.P. Sitte, 10/05/2016
// E. Weiand - 2020/03/04 - added nanoparticle/tauD dummy slots
template<class CloudType>
void Foam::PhaseChangeModel<CloudType>::calculateAS
(
    const scalar,
    const label,
    const scalar,
...
) const
{
    notImplemented
    (
        "void Foam::PhaseChangeModel<CloudType>::calculate2"
        "("
            "const scalar, "
            "const label, "
            "const scalar, "
